    ...
    exploring: [
      {
        title: "System Design",
        detail:
          "Understanding distributed architectures, scalability patterns, and how large-scale ML systems are designed for reliability and throughput.",
      },
      {
        title: "Large Language Models",
        detail:
          "Going deep on LLM internals—fine-tuning, RLHF, RAG architectures, serving at scale with vLLM, and evaluation frameworks.",
      },
      {
        title: "Multi-Agent Systems",
        detail:
          "Exploring autonomous agent frameworks, typed communication graphs, tool-calling patterns, and orchestration with LangGraph.",
      },
    ],
    principles: [
      {
        ...
        description:
          "Translating academic papers into production systems—whether it's implementing RAG from scratch or running RL experiments in simulation environments.",
      },
      {
        title: "Metrics-Driven Evaluation",
        description:
          "Never deploying without proper benchmarks. Using Dice Coefficient for segmentation, reward curves for RL, and hallucination rates for LLM pipelines.",
      },
      {
        title: "Clean, Modular Code",
        description:
          "Building AI components as reusable, swappable modules so models, retrievers, and APIs can be upgraded without rewriting everything.",
      },
    ],
  },
  ...
  projects: [
    {
      ...
      subtitle:
        "Evidence-grounded medical response system with ~80% hallucination reduction using Llama 3 & FAISS",
      description:
      ...
      caseStudy: {
        overview:
          "Developed a clinical decision support system at SRIHER(DU) to provide evidence-grounded medical responses, reducing over-reliance on LLM hallucinations through semantic retrieval from authoritative medical PDFs.",
        challenge:
          "Baseline LLMs hallucinate medical facts at unacceptable rates in clinical contexts. The system needed multilingual support (English, Hindi, Tamil), emergency detection, and mandatory source citations while maintaining conversational quality.",
        architecture: [
...
chain = RetrievalQA.from_chain_type(
    ...
    },
    {
      ...
      subtitle:
        "Comparative study of Q-Learning, DQN & Double DQN for adaptive traffic optimization in SUMO",
      description:
      ...
      githubUrl:
        "https://github.com/Nithish-S-B/rl-traffic-signal-comparative-study",
      caseStudy: {
        overview:
          "Conducted a rigorous comparative study of three RL algorithms for adaptive traffic signal control at a four-way intersection, with a modular framework designed for future multi-intersection extension.",
        challenge:
          "Traditional fixed-time traffic signals fail under variable traffic loads. The challenge was designing a reward function and state representation that generalizes across different traffic density patterns.",
        architecture: [
    ...
    },
    {
      ...
      subtitle:
        "U-Net CNN architecture for whole tumor, tumor core & enhancing tumor region segmentation",
      description:
      ...
      caseStudy: {
        overview:
          "Implemented an automated brain tumor segmentation system at SRIHER(DU), targeting three clinically critical tumor sub-regions from multi-modal MRI scans to assist radiological workflows.",
        challenge:
          "Brain tumor boundaries are highly irregular and class-imbalanced. Accurately segmenting all three sub-regions (whole tumor, tumor core, enhancing tumor) simultaneously with a single model requires careful architecture design.",
        architecture: [
    ...
    },
    {
      ...
      subtitle:
        "Deep learning classification of leukemia stages from microscopic blood smear images",
      description:
      ...
      caseStudy: {
        overview:
          "Developed a deep learning-based leukemia detection and staging system using microscopic blood smear images, leveraging transfer learning on VGG19 for accurate classification.",
        challenge:
          "Microscopic blood smear images vary significantly in staining, magnification, and cell morphology. The model needed to generalize across these variations while classifying multiple stages of leukemia.",
        architecture: [
  ...
  timeline: [
    {
      ...
      description:
        "Going deep into advanced AI: deep learning architectures, natural language processing, computer vision pipelines, and reinforcement learning. Focused on understanding systems from fundamentals to production.",
      skills: [
        "Deep Learning",
        "NLP",
        "Computer Vision",
    ...
    },
    {
      ...
      description:
        "Dove into core AI and ML: neural networks, supervised/unsupervised learning, computer vision, and building first real ML models. First internships in medical AI.",
      skills: [
        "Machine Learning",
        "Neural Networks",
        "Computer Vision",
    ...
    },
    {
      ...
      description:
        "Built a strong foundation in frontend: HTML, CSS, JavaScript, and React. Developed web projects and gained appreciation for the full engineering stack that powers modern AI products.",
    ...
    },
    {
      ...
      organization: "SRIHER (DU)",
      description:
        "Began undergraduate studies in Artificial Intelligence & Machine Learning. Started the journey into programming, mathematics, and the foundations of AI.",
  ...
  capabilities: [
    {
      ...
      description:
        "Building end-to-end RAG pipelines with semantic vector retrieval (FAISS, Qdrant), embedding models, and grounded LLM generation — with safety layers for production clinical and enterprise use.",
    ...
    },
    {
      ...
      description:
        "Implementing CNN architectures (U-Net, VGG19) for medical image segmentation and classification. Experience with data augmentation, transfer learning, and evaluation metrics like Dice & IoU.",
    ...
    },
    {
      ...
      description:
        "Designing and comparing RL algorithms (Q-Learning, DQN, Double DQN) in simulation environments like SUMO. Building modular RL frameworks for real-world control problems.",
    ...
    },
    {
      ...
      description:
        "Integrating open-weight LLMs (Llama 3) via Ollama for local inference, designing multi-layer safety frameworks, multilingual prompt routing, and confidence scoring systems.",
    ...
    },
    {
      ...
      description:
        "Building end-to-end AI products with Next.js, FastAPI, TypeScript, and Python backends. Deploying with Docker and Vercel with clean API contracts.",
    ...
    },
    {
      ...
      description:
        "Currently going deep into distributed system design patterns and multi-agent orchestration frameworks — learning how scalable, production AI systems are architected.",
    ...
    topRepos: [
      {
        ...
        language: "Python",
        description:
          "AI-powered clinical decision support system leveraging Retrieval-Augmented Generation (RAG), Llama 3, Ollama, and FAISS for evidence-based medical assistance.",
      ...
      },
      {
        ...
        language: "Python",
        description:
          "Comparative study of Q-Learning, DQN & Double DQN for adaptive traffic signal control using SUMO simulation.",
      ...
      },
      {
        ...
        language: "JavaScript",
        description:
          "A grocery management web application built with modern frontend technologies.",
  ...
  aiAssistant: {
    systemPrompt:
      "You are Ask Nithish AI, a personal assistant representing S B Nithish, a B.Tech AI & ML student (2022-2026) at SRIHER(DU). Answer questions concisely, professionally, and accurately using Nithish's background. He has completed 4 AI/ML internships, built RAG systems, RL agents, and medical imaging models.",
    samplePrompts: [
    ...
    knowledgeBase: [
      ...
      },
      {
        ...
        response:
          "Nithish implemented an **automated brain tumor segmentation** system at SRIHER(DU) (May–Jun 2025) using a U-Net CNN architecture. It segments three clinically critical regions: whole tumor, tumor core, and enhancing tumor from multi-modal MRI scans. Evaluated using Dice Coefficient and IoU metrics.",
      },
      {
        keywords: [
          "leukemia",
        ...
        response:
          "Nithish built a **leukemia detection system** at SRIHER(DU) (Aug–Oct 2024) using VGG19 CNN with transfer learning. He performed image preprocessing and data augmentation on microscopic blood smear images to classify various stages of leukemia.",
      },
      {
        keywords: [
          "skills",
        ...
        response:
          "Nithish's core technical stack includes **Python, SQL, TypeScript, JavaScript, PyTorch, FastAPI, pandas, NumPy, PostgreSQL, Docker, Vercel, Git, GitHub, VS Code, and Postman**. In AI/ML he works with FAISS, Llama 3, Ollama, U-Net, VGG19, DQN/Double DQN, and MiniLM embeddings. He's currently exploring system design, advanced LLMs, and multi-agent frameworks.",
      },
      {
        keywords: ["contact", "email", "reach", "hire", "linkedin", "resume"],
        response:
          "You can reach Nithish at **nithish.sb.work@gmail.com**, connect on [LinkedIn](https://www.linkedin.com/in/nithish-s-b-/), or browse his work on [GitHub](https://github.com/Nithish-S-B). He is open to AI Engineer and ML Engineer opportunities!",
      },
      {
        keywords: [
          "education",
        ...
        response:
          "Nithish is pursuing a **B.Tech in Artificial Intelligence & Machine Learning** at SRIHER(DU), graduating in 2026. His journey: 2022 joined AI/ML program → 2023 frontend dev → 2024 AI/ML core + first medical AI internships → 2025 advanced deep learning, NLP, CV, RL → 2026 production AI systems and exploring multi-agents & system design.",
      },
      {
        keywords: [
          "exploring",
